...
import { FactorTypeRoutingModule } from './factor-type-routing.module';
...
@NgModule({
  declarations: [
    FactorTypeListComponent,
    NewFactorTypeDetailsComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
  ...
  bootstrap: [FactorTypeListComponent],
  providers: [
    CurrencyPipe,
    NewFactorTypeDetailsComponent,
  ],
})
export class FactorTypeModule { }
