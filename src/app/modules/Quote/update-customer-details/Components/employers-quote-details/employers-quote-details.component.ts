...
@Component({
  selector: 'app-employers-quote-details',
  templateUrl: './employers-quote-details.component.html',
  styleUrls: ['./employers-quote-details.component.scss']
})
export class EmployersQuoteDetailsComponent implements OnInit {
