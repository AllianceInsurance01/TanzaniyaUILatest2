...
export class CustomerDetailsComponent implements OnInit {
  ...
  getExistingBuildingList(){
    ...
    if(this.productId=='6' || this.productId=='16' || this.productId=='39' || this.productId=='14'  || this.productId=='19' || this.productId=='32' || this.productId=='1' || this.productId=='26' || this.productId=='21' || this.productId == '25' || this.productId=='42' || this.productId=='3' || this.productId=='24') urlLink = `${this.motorApiUrl}api/slide/getcommondetails`;
