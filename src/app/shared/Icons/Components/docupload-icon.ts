...
@Component({
  ...
  xml:space="preserve"
  class="docupload-icon"
>
  <g>
      <g xmlns="http://www.w3.org/2000/svg">
          <g>
              <g>
                  <circle cx="158" cy="144.4" r="28.8" fill="#000000" data-original="#000000" class=""></circle>
                  <path
...
export class DocuploadIconComponent implements OnInit {
  constructor() {}
  ngOnInit() {}
}
